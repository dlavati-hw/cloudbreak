...
public class EnvironmentLoadBalancerService {
    ...
    public void updateLoadBalancerInEnvironmentAndStacks(EnvironmentDto environmentDto, EnvironmentLoadBalancerDto environmentLbDto) {
        ...
        if (!entitlementService.publicEndpointAccessGatewayEnabled(ThreadBasedUserCrnProvider.getAccountId()) &&
            ...
            reactorFlowManager
                .triggerLoadBalancerUpdateFlow(environmentDto, environment, environmentLbDto.getEndpointAccessGateway(),
                    environmentLbDto.getEndpointGatewaySubnetIds(), userCrn);
        }
    }
}
