...
public class AwsPublicKeyConnector implements PublicKeyConnector {
    ...
    public void register(PublicKeyRegisterRequest request) {
        ...
        try {
            AmazonEc2RetryClient client = awsClient.createEc2RetryClient(awsCredential, request.getRegion());
    ...
    private boolean exists(AmazonEc2RetryClient client, String publicKeyId) {
        try {
