...
public class AwsElasticIpService {
    ...
    public void associateElasticIpsToInstances(AmazonEc2RetryClient amazonEC2Client, List<String> eipAllocationIds, List<String> instanceIds) {
    ...
    private void associateElasticIpToInstance(AmazonEc2RetryClient amazonEC2Client, String eipAllocationId, String instanceId) {
    ...
    public List<String> getFreeIps(Collection<String> eips, AmazonEc2RetryClient amazonEC2Client) {
