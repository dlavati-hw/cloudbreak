...
public class AwsLoadBalancerLaunchService {
    ...
    @VisibleForTesting
    boolean checkForLoadBalancerAndTargetGroupResources(AmazonCloudFormationRetryClient cfRetryClient, String cFStackName,
            List<AwsLoadBalancer> awsLoadBalancers) {
    ...
    @VisibleForTesting
    boolean checkForListenerResources(AmazonCloudFormationRetryClient cfRetryClient, String cFStackName,
            List<AwsLoadBalancer> awsLoadBalancers) {
        ListStackResourcesResult result = cfRetryClient.listStackResources(awsStackRequestHelper.createListStackResourcesRequest(cFStackName));
