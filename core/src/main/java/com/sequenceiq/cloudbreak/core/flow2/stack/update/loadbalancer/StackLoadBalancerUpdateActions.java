...
public class StackLoadBalancerUpdateActions {
    ...
    public Action<?, ?> loadBalancerUpdateFinishedAction() {
        return new AbstractStackLoadBalancerUpdateAction<>(UpdateActionsFinishedSuccess.class) {
            @Override
            protected void doExecute(StackContext context, UpdateActionsFinishedSuccess payload, Map<Object, Object> variables) {
