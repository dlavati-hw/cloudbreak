...
public class ImageCatalogV4Controller extends NotificationController implements ImageCatalogV4Endpoint {
    ...
    public ImageCatalogV4Responses list(@FilterParam(ImageCatalogFiltering.WORKSPACE_ID) Long workspaceId) {
        Set<ImageCatalog> allByWorkspaceId = imageCatalogFiltering.filterImageCatalogs(AuthorizationResourceAction.DESCRIBE_IMAGE_CATALOG, workspaceId);
