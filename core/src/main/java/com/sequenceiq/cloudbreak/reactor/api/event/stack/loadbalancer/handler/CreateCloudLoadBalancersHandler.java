...
public class CreateCloudLoadBalancersHandler extends ExceptionCatcherEventHandler<CreateCloudLoadBalancersRequest> {
    ...
    protected Selectable doAccept(HandlerEvent event) {
        ...
        try {
            LOGGER.debug("Updating cloud stack with load balancer network information");
            ...
            LOGGER.debug("Cloud load balancer creation successful");
            return new CreateCloudLoadBalancersSuccess(request.getResourceId());
        } catch (Exception e) {
